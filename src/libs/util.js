...
// Prints to console
var printf = (fmt = "", error = false, ...rest) => {
...
var editTableData = (zeroframe, mergerType, mergerAddress, auth_address, table, manageDataFunc, beforePublishCB = null) => {
...
var uploadBigFile = (zeroframe, mergerType, mergerAddress, auth_address, file, f = null, checkOptF = checkOptional, curoptional = ".+\\.(mp4|ogg|webm|cast|MP4|OGG|WEBM|CAST)(.piecemap.msgpack)?") => {
...
// TODO: Add flags for the filetypes to allow
var checkOptional = (zeroframe, mergerType, mergerAddress, auth_address, doSignPublish, f = null, curoptional = ".+\\.(mp4|ogg|webm|cast|MP4|OGG|WEBM|CAST)(.piecemap.msgpack)?") => {
...
module.exports = {
	sprintf, printf, editTableData, editData, makeCurOptional, uploadBigFile, checkOptional
};